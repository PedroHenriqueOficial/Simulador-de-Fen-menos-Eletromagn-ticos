...
Desenvolvimento de um simulador de fenômenos eletromagnéticos. O simulador foi estruturado em três módulos principais: 

* O primeiro destinado à representação de **campos elétricos**. 
